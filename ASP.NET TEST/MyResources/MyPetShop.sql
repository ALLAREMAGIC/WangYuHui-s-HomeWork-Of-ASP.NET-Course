...
ON 
( NAME = MyPetShop,
    FILENAME = 'C:\Users\Magic Computer\Desktop\临时文件\大三上动态网站2\仓库\WangYuHui-s-HomeWork-Of-ASP.NET-Course\ASP.NET TEST\App_Data\MyPetShop.mdf',
    SIZE = 5MB,
    MAXSIZE = 50MB,
    FILEGROWTH = 1MB )
LOG ON
( NAME = MyPetShop_log,
    FILENAME = 'C:\Users\Magic Computer\Desktop\临时文件\大三上动态网站2\仓库\WangYuHui-s-HomeWork-Of-ASP.NET-Course\ASP.NET TEST\App_Data\MyPetShop_log.ldf',
    SIZE = 3MB,
    MAXSIZE = 25MB,
    FILEGROWTH = 1MB )
